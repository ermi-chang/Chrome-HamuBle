...
const TRANSLATIONS = {
  ...
  zh: {
    ...
    navSettings:     '设置',
    // Dashboard
    dashEventsTitle:      '活动公告',
    dashHostSummaryTitle: '今日自发',
    dashHostTotalPre:     '共 ',
    dashHostTotalPost:    ' 次',
    dashHostEmpty:        '今天还没有自发记录',
    dashDropLogTitle:     '掉落日历',
    weekdayMon:           '周一',
    weekdayTue:           '周二',
    weekdayWed:           '周三',
    weekdayThu:           '周四',
    ...
    settingsDropResetConfirm: '清空所有掉落记录吗？此操作无法撤销。',
    settingsDropChipDelTitle: '点击删除',
    settingsDropUrlPh:        '粘贴 GBF 物品/武器图标 URL（m/s/b 任一格式）',
    settingsDropUrlOk:        '添加',
    settingsDropUrlErrInvalid:'请粘贴 GBF 资源 URL（包含 /sp/assets/.../m|s|b/数字.jpg|png）',
    settingsDropUrlErrLimit:  '监视已满（最多 20 项）。请先删除一些再添加。',
    // Recent observed drops footer
    recentDropsLabel:    '本场',
    recentDropsEmpty:    '打过一场战斗后这里会出现候选',
    recentDropAddTitle:  '点击添加到监视',
    recentDropAddedTitle:'已加入监视',
    // Settings panel
    settingsTitle:        '⚙ 详细设置',
